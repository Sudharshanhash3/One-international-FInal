...
! function(t) {
    ...
    e.Defaults = {
        ...
        this.destroy(), this.settings = t.extend({}, this.options), this.$element.addClass("arcontactus-widget").addClass("arcontactus-message"), "left" === this.settings.align ? this.$element.addClass("left") : this.$element.addClass("right"), this.settings.items.length ? (this.$element.append("\x3c!--noindex--\x3e"), this._initCallbackBlock(), "regular" == this.settings.mode && this._initMessengersBlock(), this._initMessageButton(), this._initPrompt(), this._initEvents(), this.startAnimation(), this.$element.append("\x3c!--/noindex--\x3e"), this.$element.addClass("active")) : console.info("jquery.contactus:no items"), this._initialized = !0, this.$element.trigger("arcontactus.init")
        ...
        "large" === this.settings.buttonSize && this.$element.addClass("lg"), "huge" === this.settings.buttonSize && this.$element.addClass("hg"), "medium" === this.settings.buttonSize && this.$element.addClass("md"), "small" === this.settings.buttonSize && this.$element.addClass("sm");
        var n = t("<div>", {
            class: "static"
        });
        ...
        e.find(".arcontactus-message-button").on("mousedown", function(t) {
            ...
            t.pageX === s.x && t.pageY === s.y && ("regular" == s.settings.mode ? s.toggleMenu() : s.openCallbackPopup(), t.preventDefault())
            ...
            s._processHash()
        }, 500), t(window).on("hashchange", function(t) {
            s._processHash()
        })
    }, e.prototype._processHash = function() {
        var t = this;
        ...
        if ("huge" === this.settings.buttonSize) var a = 2,
            o = 0;
        if ("large" === this.settings.buttonSize) a = 2, o = 0;
