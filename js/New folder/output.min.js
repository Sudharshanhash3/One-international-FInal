! function(t) {
    ...
    var e, i = null;
    e = function(t) {
        return void 0 !== t && "object" == typeof t && (this.$el = t.$el || null, this.$tooltip = null, this.$arrow = null, this.margins = {
            border: 6,
            top: 15,
            right: 15,
            bottom: 15,
            left: 15
        }, this.settings = {}, this.themes = {}, this.isJqueryObject(this.$el) && !this.$el.data().hasOwnProperty("simpletooltipInstanced") && (this.title = this.$el.attr("title"), void 0 !== this.title && this.title.length)) ? (this.$el.attr("title", ""), this.setOptions(t.settings), this.setTooltip(), this.initialize(), this.$el.data("simpletooltip-instanced", "1"), this) : void 0
    }, e.defaults = {
        position: "top",
        color: "#DDDDDD",
    ...
    }, e.prototype.isJqueryObject = function(t) {
        return null !== t && void 0 !== t && "object" == typeof t && void 0 !== t.jquery
    }, e.prototype.setTooltip = function() {
        return this.isJqueryObject(this.$tooltip) && this.isJqueryObject(this.$arrow) ? void 0 : (this.$tooltip = t(e.templates.tooltip), this.$tooltip.html(this.title), this.$tooltip.addClass(this.getAttribute("position")), this.$arrow = t(e.templates.arrow), this.$tooltip.append(this.$arrow), this.$tooltip)
    }, e.prototype.setOptions = function(i) {
        void 0 !== i && "object" == typeof i && (this.settings = t.extend(e.defaults, i), void 0 !== this.settings.themes && "object" == typeof this.settings.themes && (this.themes = t.extend(e.themes, this.settings.themes), delete this.settings.themes), void 0 !== this.themes[this.settings.theme] && (this.settings = t.extend(this.settings, this.themes[this.settings.theme])))
    }, e.prototype.initialize = function() {
        this.$el.on("mouseenter", {
            that: this
        }, this.mouseOver), this.$el.on("mouseleave", {
            that: this
        }, this.mouseOut), this.$el.attr("title", "")
    }, e.prototype.getAttribute = function(t) {
        var e, i = "simpletooltip-" + t.replace("_", "-");
        return void 0 !== this.$el.data(i) ? this.$el.data(i) : void 0 !== (e = this.$el.data("simpletooltip-theme")) && void 0 !== this.themes[e] && void 0 !== this.themes[e][t] ? this.themes[e][t] : void 0 !== this.settings[t] && this.settings[t]
    }, e.prototype.mouseOver = function(t) {
        var e = t.data.that;
        return e.$tooltip.parent().length ? t : (i.append(e.$tooltip), e.$tooltip.hide(), e.styleTooltip(), e.getAttribute("fade") ? e.$tooltip.delay(180).fadeIn(200) : e.$tooltip.show(), t)
    }, e.prototype.mouseOut = function(t) {
        var e = t.data.that;
        return e.$tooltip.parent().length ? e.$tooltip.css("opacity") ? (e.getAttribute("fade") ? e.$tooltip.clearQueue().stop().fadeOut(100, function() {
            e.$tooltip.remove()
        }) : e.$tooltip.remove(), t) : (e.$tooltip.remove(), t) : t
    }, e.prototype.styleTooltip = function() {
        if (this.isJqueryObject(this.$el) && this.isJqueryObject(this.$tooltip)) {
            var e = this.$el.offset(),
                i = this.getAttribute("background_color"),
                s = this.getAttribute("border_color");
            this.isJqueryObject(this.$arrow) || (this.$arrow = this.$tooltip.find(" > .arrow"));
            var o = this.getAttribute("border_width");
            o = s && "boolean" != typeof o && "none" !== o ? Number(o) : 0;
            var n = o && s ? s : i,
                r = Math.round(3 * this.settings.arrow_width / 4),
                a = -parseInt(2 * this.settings.arrow_width + o, 10),
                h = -parseInt(2 * r + o, 10),
                l = {
            ...
            switch (this.getAttribute("position")) {
                case "top-right":
                    e.top -= parseInt(this.$tooltip.outerHeight() + this.margins.bottom, 10), e.left += parseInt(this.$el.outerWidth() - this.margins.right - this.margins.border, 10), this.$arrow.css({
                        left: this.settings.padding.width - o,
                        borderWidth: r,
                        bottom: h,
                        borderTopColor: n,
                        borderLeftColor: n
                    ...
                    break;
                case "right-top":
                    e.top -= parseInt(this.$tooltip.outerHeight() - this.margins.bottom, 10), e.left += parseInt(this.$el.outerWidth() + this.margins.right, 10), this.$arrow.css({
                        bottom: this.settings.padding.height - o,
                        borderWidth: r,
                        left: h,
                        borderRightColor: n,
                        borderBottomColor: n
                    ...
                    break;
                case "right":
                    e.top += parseInt((this.$el.outerHeight() - this.$tooltip.outerHeight()) / 2, 10), e.left += parseInt(this.$el.outerWidth() + this.margins.right, 10), this.$arrow.css({
                        left: a,
                        borderRightColor: n,
                    ...
                    break;
                case "right-bottom":
                    e.top += parseInt(this.$el.outerHeight() - this.margins.bottom, 10), e.left += parseInt(this.$el.outerWidth() + this.margins.right, 10), this.$arrow.css({
                        top: this.settings.padding.height - o,
                        borderWidth: r,
                        left: h,
                        borderRightColor: n,
                        borderTopColor: n
                    ...
                    break;
                case "bottom-right":
                    e.top += parseInt(this.$el.outerHeight() + this.margins.bottom, 10), e.left += parseInt(this.$el.outerWidth() - this.margins.right - this.margins.border, 10), this.$arrow.css({
                        left: this.settings.padding.width - o,
                        borderWidth: r,
                        top: h,
                        borderBottomColor: n,
                    ...
                    break;
                case "bottom":
                    e.top += parseInt(this.$el.outerHeight() + this.margins.bottom, 10), e.left += parseInt((this.$el.outerWidth() - this.$tooltip.outerWidth()) / 2, 10), this.$arrow.css({
                        top: a,
                    ...
                    break;
                case "bottom-left":
                    e.top += parseInt(this.$el.outerHeight() + this.margins.bottom, 10), e.left -= parseInt(this.$tooltip.outerWidth() - this.margins.left - this.margins.border, 10), this.$arrow.css({
                        right: this.settings.padding.width - o,
                        borderWidth: r,
                        top: h,
                        borderBottomColor: n,
                        borderRightColor: n
                    ...
                    break;
                case "left-bottom":
                    e.top += parseInt(this.$el.outerHeight() - this.margins.bottom, 10), e.left -= parseInt(this.$tooltip.outerWidth() + this.margins.left, 10), this.$arrow.css({
                        top: this.settings.padding.height - o,
                        borderWidth: r,
                        right: h,
                        borderLeftColor: n,
                    ...
                    break;
                case "left":
                    e.top += parseInt((this.$el.outerHeight() - this.$tooltip.outerHeight()) / 2, 10), e.left -= parseInt(this.$tooltip.outerWidth() + this.margins.left, 10), this.$arrow.css({
                        right: a,
                        borderLeftColor: n,
                        marginTop: -this.settings.arrow_width
                    });
                    break;
                case "left-top":
                    e.top -= parseInt(this.$tooltip.outerHeight() - this.margins.bottom, 10), e.left -= parseInt(this.$tooltip.outerWidth() + this.margins.left, 10), this.$arrow.css({
                        bottom: this.settings.padding.height - o,
                        borderWidth: r,
                        right: h,
                        borderLeftColor: n,
                ...
                case "top-left":
                    ...
                    break;
                default:
                    e.top -= parseInt(this.$tooltip.outerHeight() + this.margins.top, 10), e.left += parseInt((this.$el.outerWidth() - this.$tooltip.outerWidth()) / 2, 10), this.$arrow.css({
                        bottom: a,
                        borderTopColor: n,
                        marginLeft: -this.settings.arrow_width
                    })
            }
            this.$tooltip.css(t.extend(l, {
                top: e.top,
                left: e.left
            }))
        }
    }, t.fn.simpletooltip = function(i) {
        return this.each(function() {
            var s = t(this);
            if (!s.data().hasOwnProperty("simpletooltipInstanced")) {
                var o = {
                    $el: s
                };
                void 0 !== i && "object" == typeof i && (o.settings = i), new e(o)
            }
        })
    }, t(window).on("load", function() {
        i = t("body"), t('[data-simpletooltip="init"]').each(function() {
            t(this).simpletooltip()
        })
    })
}(jQuery),
function(t, e) {
    ...
    function i(i, n, a) {
        function h(t, e, s) {
            ...
            return t.each(function(t, h) {
                var l = a.data(h, i);
                if (!l) return void r(i + " not initialized. Cannot call methods, i.e. " + n);
                var u = l[e];
                if (!u || "_" == e.charAt(0)) return void r(n + " is not a valid method");
                var d = u.apply(l, s);
                o = void 0 === o ? d : o
            }), void 0 !== o ? o : t
        }
...
function(t, e) {
    ...
    function o() {
        if (!u) {
            ...
            i.appendChild(e);
            var o = s(e);
            r = 200 == Math.round(t(o.width)), n.isBoxSizeOuter = r, i.removeChild(e)
        }
    }
    ...
    function n(e) {
        if (o(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            for (var u = a.isBorderBox = "border-box" == n.boxSizing, d = 0; d < l; d++) {
                var c = h[d],
                    p = n[c],
                    g = parseFloat(p);
                a[c] = isNaN(g) ? 0 : g
            ...
            var m = a.paddingLeft + a.paddingRight,
                f = a.paddingTop + a.paddingBottom,
            ...
            var z = t(n.height);
            return !1 !== z && (a.height = z + (b ? 0 : f + w)), a.innerWidth = a.width - (m + _), a.innerHeight = a.height - (f + w), a.outerWidth = a.width + y, a.outerHeight = a.height + v, a
        }
    }
    ...
    return i.htmlInit = function(e, s) {
        i.docReady(function() {
            ...
            l.forEach(function(t) {
                var i, n = t.getAttribute(r) || t.getAttribute(u);
                try {
                    i = n && JSON.parse(n)
                } catch (e) {
...
function(t, e) {
    ...
    var o = document.documentElement.style,
        ...
        l = s.prototype = Object.create(t.prototype);
    ...
    l.ontransitionend = function(t) {
        if (t.target === this.element) {
            var e = this._transn,
                s = d[t.propertyName] || t.propertyName;
            if (delete e.ingProperties[s], i(e.ingProperties) && this.disableTransition(), s in e.clean && (this.element.style[t.propertyName] = "", delete e.clean[s]), s in e.onEnd) {
                e.onEnd[s].call(this), delete e.onEnd[s]
            }
...
function(t, e) {
    ...
    function a(t) {
        ...
        var e = t.match(/(^\d*\.?\d*)(\w*)/),
            i = e && e[1],
            s = e && e[2];
        return i.length ? (i = parseFloat(i)) * (g[s] || 1) : 0
    }
    var h = t.console,
        l = t.jQuery,
        u = function() {},
...
function(t, e) {
    ...
    return s._resetLayout = function() {
        ...
        for (var o = this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition", n = this[o](s, t), r = {
                x: this.columnWidth * n.col,
                y: n.y
            }, a = n.y + t.size.outerHeight, h = s + n.col, l = n.col; l < h; l++) this.colYs[l] = a;
        return r
        ...
        for (var l = this._getOption("originTop"), u = (l ? s.top : s.bottom) + i.outerHeight, d = a; d <= h; d++) this.colYs[d] = Math.max(u, this.colYs[d])
...
function(t, e) {
    "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "desandro-matches-selector/matches-selector", "fizzy-ui-utils/utils", "isotope-layout/js/item", "isotope-layout/js/layout-mode", "isotope-layout/js/layout-modes/masonry", "isotope-layout/js/layout-modes/fit-rows", "isotope-layout/js/layout-modes/vertical"], function(i, s, o, n, r, a) {
        return e(t, i, s, o, n, r, a)
    ...
    d._create = function() {
        ...
        for (var i = [], s = [], o = [], n = this._getFilterTest(e), r = 0; r < t.length; r++) {
            ...
            if (!a.isIgnored) {
                var h = n(a);
                h && i.push(a), h && a.isHidden ? s.push(a) : h || a.isHidden || o.push(a)
            }
        }
        return {
            matches: i,
            ...
            n || (n = new o(this, "object" == typeof e && e), s.data("owl.carousel", n), t.each(["next", "prev", "to", "destroy", "refresh", "replace", "add", "remove"], function(e, i) {
                n.register({
                    ...
                    t.namespace && t.relatedTarget !== this && (this.suppress([i]),
                        n[i].apply(this, [].slice.call(arguments, 1)), this.release([i]))
                }, n))
...
function(t, e, i, s) {
    ...
    o.Defaults = {
        ...
        t.each(o, function(e, i) {
            n.push(t(i).height())
        }), r = Math.max.apply(null, n), r <= 1 && s && this._previousHeight && (r = this._previousHeight), this._previousHeight = r, this._core.$stage.parent().height(r).addClass(this._core.settings.autoHeightClass)
    }, o.prototype.destroy = function() {
        var t, e;
        for (t in this._handlers) this._core.$element.off(t, this._handlers[t]);
        for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
...
function(t, e, i, s) {
    ...
    o.Defaults = {
        ...
        var s, o, n, r = i.width && i.height ? "width:" + i.width + "px;height:" + i.height + "px;" : "",
            ...
            d = function(i) {
                o = '<div class="owl-video-play-icon"></div>', s = u.lazyLoad ? t("<div/>", {
        ...
        this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), o = this._core.items(this._core.relative(o.index())), this._core.reset(o.index()), i = t('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>'), i.attr("height", a), i.attr("width", r), "youtube" === n.type ? i.attr("src", "//www.youtube.com/embed/" + n.id + "?autoplay=1&rel=0&v=" + n.id) : "vimeo" === n.type ? i.attr("src", "//player.vimeo.com/video/" + n.id + "?autoplay=1") : "vzaar" === n.type && i.attr("src", "//view.vzaar.com/" + n.id + "/player?autoplay=true"), t(i).wrap('<div class="owl-video-frame" />').insertAfter(o.find(".owl-video")), this._playing = o.addClass("owl-video-playing"))
...
! function(t) {
    ...
    return t.fn.tilt = function(e) {
        var i = function() {
            ...
            s = function() {
                var e = this;
                t(this).on("mousemove", a), t(this).on("mouseenter", n), this.settings.reset && t(this).on("mouseleave", h), this.settings.glare && t(window).on("resize", c.bind(e))
            },
            o = function() {
                var e = this;
        ...
        return t.fn.tilt.destroy = function() {
            ...
            this.settings = t.extend({
                ...
                t(i).data("settings", i.settings), i.settings.glare && d.call(i), s.call(i)
            }, this.init()
        })
    }, t("[data-tilt]").tilt(), !0
});