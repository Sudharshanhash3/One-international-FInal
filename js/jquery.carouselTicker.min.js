    ...
    function s() {
      (l.itemsWidth = 0),
        l.$items.each(function () {
          ...
          t.hasClass(l.cloneCls) ||
            (l.itemsWidth += this.getBoundingClientRect().width + n);
        });
    }
    function o() {
      (l.itemsHeight = 0),
        ...
        e(i.target).off("click"),
          ...
          o.on(l.eventTypes.mousemove, function (i) {
            ...
            l.touch &&
              ...
              "horizontal" === l.settings.mode
                ? (l.directionSwitcher = u >= 0 ? -1 : 1)
                : "vertical" === l.settings.mode &&
                  (l.directionSwitcher = d >= 0 ? -1 : 1),
              (l.isMousemove = !0),
              t &&
                ("horizontal" === l.settings.mode
                  ? (r - u >= 0 &&
    ...
    var d = function () {
      ...
      v = function () {
        ...
        "horizontal" === l.settings.mode
          ? (s(),
            l.itemsWidth > l.$parent.width() &&
              (u.find("." + l.wrapCls).css({ width: l.$parent.width() + "px" }),
          ...
          l.isInitialize &&
            u.on("dragstart", function (e) {
              return "IMG" == e.target.nodeName.toUpperCase() ||
    ...
    return (
      ...
      (h.destructor = function () {
        u.find("." + l.cloneCls).remove(),
          u.find("." + l.wrapCls).length &&
            (l.$list.unwrap(),
            l.$list.css({ left: "auto", position: "static", width: "auto" }),
            u.css({ width: "auto", position: "static" })),
          clearInterval(l.intervalPointer),
          (l.isInitialize = !1),
          (l.intervalPointer = !1);
      }),
